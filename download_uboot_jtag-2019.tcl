...
set PS7    vivado/ps7_init.tcl
set BIT    /media/douglas/extssd/FPGA/EBAZ4205/EBAZ4205_tutorial/tutorials/01_blink/project_1/project_1.runs/impl_1/blink.bit
...
catch {exec dd if=$BOOTBIN of=$UBOOT bs=1 skip=[expr 0x868c0] count=[expr 0x22693] 2>/dev/null}
...
# PL 비트스트림 로드 (호환 비트스트림 없으면 생략 가능)
# target 1
# fpga $BIT
